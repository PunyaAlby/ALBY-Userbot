...
└❖ **Berfungsi :** Untuk mengubah volume
 
┌❖ **Perintah   :** {cmd}playlist
└❖ **Berfungsi :** Untuk menampilkan daftar putar

┌❖ **Perintah   :** {cmd}joinvc
└❖ **Berfungsi :** Untuk Join Vcg Menggunakan bot(fake os)

┌❖ **Perintah   :** {cmd}leavevc
└❖ **Berfungsi :** Untuk Turun Vcg Menggunakan bot(fake os)
""")
                await event.edit(
                    text,
                    file=albylogo,
