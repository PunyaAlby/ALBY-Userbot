...
async def crbn(event):
    ...
    xx = await Carbon(code=code, file_name="alby_karbon", backgroundColor=col)
    await xxxx.delete()
    await event.reply(
...
CMD_HELP.update(
    {
        "albycarbon": f"❖ **Plugin : **`carbon`\
        \n\n ┌❖ **Perintah :** `.carbon` <text/reply>\
        \n └❖ **Berfungsi : **Carbonisasi teks dengan pengaturan default.\
        \n\n ┌❖ **Perintah :** `.rcarbon` <text/reply>\
        \n └❖ **Berfungsi : **Carbonisasi teks, dengan warna background acak.\
        \n\n ┌❖ **Perintah :** `.ccarbon` <warna> <text/reply>\
        \n └❖ **Berfungsi : **Carbonisasi teks, dengan warna background custom.\
    "
    }
)
