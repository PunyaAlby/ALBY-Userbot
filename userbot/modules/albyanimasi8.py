...
\n\n`.hadiah`\
\nUsage: Memberi Hadiah Tapi Aku Tidak Mau Memberi Tahu Apa Dalamnya!\
\n\n`.polisi`\
...
\n\n`.jaralby`\
\nUsage: Jaringan Mu Lambat?? Tingkatkan jaringan mu Menggunakan Ini\
