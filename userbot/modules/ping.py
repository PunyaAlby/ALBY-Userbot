...
async def pingme(pong):
    ...
    uptime = await get_readable_time((time.time() - StartTime))
    start = datetime.now()
    await pong.edit("___________________🏍️")
    await pong.edit("________________🏍️___")
    await pong.edit("______________🏍️_____")
    await pong.edit("___________🏍️________")
    await pong.edit"________🏍️___________")
    await pong.edit("_____🏍️______________")
    await pong.edit("__🏍️_________________")
    await pong.edit("🏍️___________________")
    await pong.edit("✨")
