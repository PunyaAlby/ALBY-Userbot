...
import psutil
from userbot import ALIVE_LOGO, ALIVE_NAME, BOT_VER, CMD_HELP, ALBY_TEKS_KUSTOM, StartTime, UPSTREAM_REPO_BRANCH, bot
...
async def redis(alive):
    ...
    output = (
        ...
        f"**Telethon Version :** `{version.__version__}` \n"
        f"**Owner ALBY Userbot :** `[『ⒶⓁⒷⓎ』](https://t.me/Punya_Alby)` \n"
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/{GROUP})** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/{CHANNEL})** | **[𝗢𝘄𝗻𝗲𝗿]({DEFAULTUSER})**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
