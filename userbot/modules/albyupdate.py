...
async def update(event, repo, ups_rem, ac_br):
    ...
    x = await edit_or_reply(event, "**✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨** `Berhasil Di Update!`")
    await asyncio.sleep(1)
    await x.edit("**✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨** `Di Restart....`")
    await asyncio.sleep(1)
...
@alby_cmd(pattern="update(?: |$)(now|deploy)?")
...
async def upstream(event):
    ...
    if force_update:
        ...
        await xx.edit("` Proses Update ✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨, Loading....1%`")
        await xx.edit("` Proses Update ✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨ Loading....20%`")
        await xx.edit("` Proses Update ✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨, Loading....35%`")
        await xx.edit("` Proses Update ✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨, Loading....77%`")
        await xx.edit("` Proses Update ✨ ᴀʟʙʏ ᴜꜱᴇʀʙᴏᴛ ✨, Updating...90%`")
        await xx.edit(
