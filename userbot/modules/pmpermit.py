...
DEF_UNAPPROVED_MSG = (
    ...
    "                ᴘʀɪᴠᴀᴄʏ ᴍᴇssᴀɢᴇ     \n"
    "╚═════════════════════╝\n"
    "**ᴅɪᴍᴏʜᴏɴ ᴜɴᴛᴜᴋ ᴛɪᴅᴀᴋ ᴍᴇʟᴀᴋᴜᴋᴀɴ ꜱᴘᴀᴍ ᴄʜᴀᴛ!** \n"
    f"**ᴋᴀʀᴇɴᴀ ʙɪꜱᴀ ᴍᴇɴɢɢᴀɴɢᴜ** {owner} \n"
    f"**ᴊɪᴋᴀ ᴀɴᴅᴀ ᴍᴀꜱɪʜ ᴍᴇʟᴀᴋᴜᴋᴀɴ ꜱᴘᴀᴍ ᴄʜᴀᴛ, ᴀɴᴅᴀ ᴀᴋᴀɴ ᴛᴇʀʙʟᴏᴋɪʀ ᴏᴛᴏᴍᴀᴛɪꜱ!**\n"
    "╭╌╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╌╮\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(VVIP)))
